...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "WHEN WE ALL FALL ASLEEP, WHERE DO WE GO", NULL, NULL);
    if (window == NULL)
    {
    ...
    // configure global opengl state to enable depth testing
    // -----------------------------
    ...
    {
        // per-frame time logic for camera speed control
        // --------------------
